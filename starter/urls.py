...
urlpatterns = [
    ...
    url(r'^v1/change_password/(?P<id>[/\w-]+)/$', PasswordChangeViewSet.as_view({'post': 'change'})),
    url(r'^v1/confirm/', ConfirmUserViewSet.as_view({'post': 'confirm'})),
    url(r'^v1/reset_confirm/', ResetConfirmUserToken.as_view({'post': 'confirm'})),
